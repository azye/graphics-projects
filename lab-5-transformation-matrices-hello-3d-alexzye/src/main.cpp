...
static void render()
{
    ...
    createRotateMatY(R, -0.30);


    createTranslateMat(T, -4.8, 0.0, -5.0);
    createScaleMat(S, 0.3, 2.0, 0.2);
    ...
    createTranslateMat(T, -3.0, 0.0, -5.0);
    createScaleMat(S, 0.3, 2.0, 0.2);
    ...
    createTranslateMat(T, -1.0, 0.0, -5.0);
    createScaleMat(S, 0.3, 2.0, 0.2);
    ...
    createTranslateMat(T, -3.9, 0.0, -5.0);
    createScaleMat(S, 0.3, 1.5, 0.2);
    createRotateMatZ(R1, 1.1);
    
    multMat(temp, R1, S);
    multMat(temp1, T, temp);
